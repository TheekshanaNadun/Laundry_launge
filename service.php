    ...
    <div class="container-fluid pt-5 pb-3">
        <div class="form-container">
            <form action="insert.php" method="post">
                ...
                <div class="first">
                    ...
                    <input type="radio" id="drycleaning" name="services" value="Dry_Cleaning,">
                    <label for="drycleaning">Dry Cleaning</label><br>

                    <input type="radio" id="pressing" name="services" value="Pressing,">
                    <label for="pressing">Pressing</label><br>

                    <input type="radio" id="ironing" name="services" value="Iorning,">
                    <label for="ironing">Ironing</label><br>
        ...
        <div class="container-fluid pt-5 pb-3">
            <div class="container">
                ...
                <h1 class="display-4 text-center mb-5">Membership</h1>
                <div class="row">
                        ...
                        <div class="bg-light text-center mb-2 pt-4">
                            <div class="d-inline-flex flex-column align-items-center justify-content-center bg-secondary rounded-circle shadow mt-2 mb-4" style="width: 200px; height: 200px; border: 15px solid #ffffff;">
                                ...
                                <h1 class="display-4 text-white mb-0">
                                    <small class="align-top" style="font-size: 22px; line-height: 45px;">$</small>19<small class="align-bottom" style="font-size: 16px; line-height: 40px;">/ Mo</small>
                                </h1>
                            </div>
                            ...
                            <a href="" class="btn btn-secondary py-2 px-4">Subscribe</a>
                        </div>
                    </div>
                    <div class="col-lg-4 mb-4">
                        <div class="bg-light text-center mb-2 pt-4">
        ...
        <section class="footer">
            <div class="contact">
                <img src="./img/logo1.jpg" alt="" srcset="">
                <p>
                    Welcome to Laundrylodge, your ultimate <br> destination for impeccable laundry services! <br> We take pride in providing top-quality and <br> hassle-free laundry solutions tailored to <br> your needs. </p>
        ...
        <section class="footer">
            <h1 class="copyright">Copyright <i class="fa-regular fa-copyright"></i> LAUNDRYLODGE. All Rights Reserved | Contact Us:+91 90000 123221.</h1>
        </section>
        <!-- Footer End -->
